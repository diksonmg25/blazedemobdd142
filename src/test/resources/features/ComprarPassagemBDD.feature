...
# Esquema do cenario é quando tem uma lista de valores - massa de dados

# Quando houver um "OU" é melhor separar em 2 ou mais cenarios
...
# Testes Negativos
  ...
  Esquema do Cenario: Login Positivo
    ...
    Exemplos:
    | email                   | senha      |
    | cliente@iterasys.com.br | Laranja25  |  # 1 teste positivo # 1 VV
 ...
 Esquema do Cenario: Login 
    ...
    | cliente@iterasys.com.br | Laranja25  | P    |Login com Sucesso        |#1 VV Postivo
